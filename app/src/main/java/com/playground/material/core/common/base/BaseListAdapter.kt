package com.playground.material.core.common.base
...
class ListAdapterViewHolder<out T : ViewBinding> constructor(val binding: T) : RecyclerView.ViewHolder(binding.root)
